...
void  vec3_clamp(vec3 v, float minVal, float maxVal);
...
void  vec3_refract(vec3 v, vec3 n, float eta, vec3 dest);
...
void  vec4_clamp(vec4 v, float minVal, float maxVal);
...
void  vec4_refract(vec4 v, vec4 n, float eta, vec4 dest);
